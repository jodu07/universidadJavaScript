// variables estaticas de solo lectura
...
let persona3 = new Persona('Luis', 'Perez');
console.log(persona3.toString());

let persona4 = new Persona('Karla', 'Amaya');
console.log(persona4.toString());

// el objeto 6 y 7 no los dejó asignar id

let persona5 = new Persona('Luisa', 'Yerlus')
console.log(persona5.toString());

let persona6 = new Persona('Carlos', 'Restrilus')
console.log(persona5.toString());
